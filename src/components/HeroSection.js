		...
		<div className='hero-section' name='home' id='home'>
			...
			<motion.div
				...
				<p className='hero-intro'>
					<span>SHREEJITH K</span> <span></span>
				</p>
				<p className='hero-desc'>
					 Hii I'M A<span className='hero-desc-sub'>SOFTWARE DEVELOPER AND DevOps ENGINEER.</span>
				</p>
			</motion.div>
			<motion.span
				...
				whileInView='visible'>
				<a
					href='SHREEJITH K CV.pdf'
					download='SHREEJITH K CV'
